...
void nhapHoaDon(HoaDon& a, Admin b)
{
	long long tien;
	string loai_hd;
	cout << "Nhap loai hoa don (Ban/Nhap) : "; getline(cin, loai_hd); // cho nhập Ban / Nhap
	...
	else
	{
		...
		else if (a.thong_tin_hang.ma_hh[0] == 'Q')
		{
...
// Xuat san pham hot
void sp_Best(Admin a, vector<HoaDon>& best_seller)
{
